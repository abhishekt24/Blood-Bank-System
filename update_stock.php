...
echo '<center style="margin-top:200px;"><h1>Stock updated successfully</h1></center>';
				echo '<center><a href="admin_stock.php";><input type="button" value="Go to Home" style="background-color: #f44336;box-shadow: 0 1px 4px black;border: none;height:35px;"></a></center>';
?>