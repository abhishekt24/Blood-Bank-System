...
if($conn->query($sql))
{
	echo '<center style="margin-top:200px;"><h1>New branch added successfully</h1></center>';
				echo '<center><a href="admin_branch.php";><input type="button" value="Go to Home" style="background-color: #f44336;box-shadow: 0 1px 4px black;border: none;height:35px;"></a></center>';
